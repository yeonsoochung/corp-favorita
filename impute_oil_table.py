...
"""
Date table:
    1. Contains date range of entire train table (2013-01-01 to 2017-08-15).
...
con.sql("""
        ...
        CREATE TABLE dates AS (
        	WITH dates_cte AS (
        		SELECT UNNEST(GENERATE_SERIES('2014-04-01'::DATE, '2017-08-31'::DATE, '1 day'::INTERVAL)) AS date
        	)
